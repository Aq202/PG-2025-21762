...
const simplifiedRunPointSchema = new Schema({
...
const SimplifiedRunPointSchema = model("simplifiedRunPoint", simplifiedRunPointSchema);
export default SimplifiedRunPointSchema;
